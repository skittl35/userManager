				            	...
				            	<div class="widget-foot">
				            		...
				            		<cfelse>
					            		...
					            		<ul class="pagination pull-right">
					                        <cfoutput>
						                        <cfif pageNum NEQ 1>
						                        	<cfset prevNum = pageNum-1>
						                        	<li>
						                        		#linkTo(text="Prev", action="index", title="Previous Page", params="pageNum=#prevNum#")#
						                        	</li>	
						                        </cfif>
						                        
						                        <li>
						                        	#linkTo(text="#boxOneNum#", action="index", title="Page #boxOneNum#", params="pageNum=#boxOneNum#")#
						                        </li>
						                        
						                        <!--- If statements to ensure page boxes do not appear needlessly --->
						                        <cfif lastPage GT 1>
						                    		<li>
						                    			#linkTo(text="#boxTwoNum#", action="index", title="Page #boxTwoNum#", params="pageNum=#boxTwoNum#")#
						                    		</li>    	
						                        </cfif>

						                        <cfif lastPage GT 2>
						                    		<li>
						                    			#linkTo(text="#boxThreeNum#", action="index", title="Page #boxThreeNum#", params="pageNum=#boxThreeNum#")#
						                    		</li>    	
						                        </cfif>

						                        <cfif pageNum NEQ lastPage>
						                      		<cfset nextNum = pageNum+1>

						                      		<li>
						                      			#linkTo(text="Next", action="index", title="Next Page", params="pageNum=#nextNum#")#
						                      		</li>
						                        </cfif>
					                        </cfoutput>
					                    </ul>
